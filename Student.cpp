...
void Student::encryptCCCD() {
	Crypto crypto;
	std::string encrypted_cccd = crypto.encrypt(this->cccd);
	strcpy(this->cccd, encrypted_cccd.c_str());
}

void Student::decryptCCCD() {
	Crypto crypto;
	std::string decrypted_cccd = crypto.decrypt(this->cccd);
	strcpy(this->cccd, decrypted_cccd.c_str());
}